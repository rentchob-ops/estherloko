...
const About = () => {
  const values = [
    { icon: <Award className="w-10 h-10 text-[#00C2A8]" />, title: "Professionnalisme", description: "Excellence et rigueur dans chaque mission." },
    { icon: <Heart className="w-10 h-10 text-[#00C2A8]" />, title: "Créativité", description: "Innovation et originalité dans mes créations." },
    { icon: <Users className="w-10 h-10 text-[#00C2A8]" />, title: "Relations Humaines", description: "Écoute, empathie et communication bienveillante." },
    { icon: <Target className="w-10 h-10 text-[#00C2A8]" />, title: "Rigueur", description: "Attention aux détails et respect des engagements." },
  ];
  ...
  return (
    <div className="pt-16">
      ...
      <section className="py-20 bg-white text-center px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-[#00C2A8] mb-12">Mon Parcours Professionnel</h2>

        <div className="max-w-4xl mx-auto space-y-12">

          {/* Formation */}
          <div className="bg-gray-50 p-8 rounded-3xl shadow-md flex flex-col items-center space-y-4 md:space-y-0 md:flex-row md:space-x-6 text-center md:text-left">
            <GraduationCap className="w-12 h-12 text-[#00C2A8]" />
            <div>
              <h3 className="text-2xl font-bold text-[#0A3764] mb-2">Formation Académique</h3>
              <p className="text-gray-700 leading-relaxed">
                Diplômée en <strong>Assistanat et Secrétariat de Direction</strong> de la Haute École de Commerce et de Management (HECM) du Bénin. Formation qui m'a dotée de compétences techniques et relationnelles essentielles pour exceller dans le domaine professionnel.
              </p>
            </div>
          </div>

          {/* Expérience */}
          <div className="bg-blue-50 p-8 rounded-3xl shadow-md flex flex-col items-center space-y-4 md:space-y-0 md:flex-row md:space-x-6 text-center md:text-left">
            <Briefcase className="w-12 h-12 text-[#00C2A8]" />
            <div>
          ...
          {/* Entrepreneuriat */}
          <div className="bg-yellow-50 p-8 rounded-3xl shadow-md flex flex-col items-center space-y-4 md:space-y-0 md:flex-row md:space-x-6 text-center md:text-left">
            <Heart className="w-12 h-12 text-[#00C2A8]" />
            <div>
      ...
      <section className="py-20 bg-primary-800 text-white text-center px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-[#00C2A8] mb-12">Mes Valeurs Fondamentales</h2>
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {values.map((value, index) => (
            <div key={index} className="bg-white text-[#0A3764] p-6 rounded-3xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
      ...
      {/* Mission */}
      <section className="py-20 bg-primary-900 text-white text-center px-6">
      ...
      <section className="py-20 bg-primary-800 text-white text-center px-6">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
          {galleryItems.map((item, index) => (
            <div key={index} className="relative group overflow-hidden rounded-3xl shadow-lg cursor-pointer">
              <img
                src={item.src}
                alt={item.title}
      ...
      {/* CTA Final */}
      <section className="py-20 bg-gradient-to-r from-[#00C2A8] to-cyan-500 text-primary-900 text-center px-6">
